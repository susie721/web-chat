...
__webpack_require__.d(__webpack_exports__, {
  "n": () => (/* binding */ withIronSessionApiRoute)
});

// UNUSED EXPORTS: withIronSessionSsr
...
var cookie = __webpack_require__(6922);
...
function withIronSessionApiRoute(handler, options) {
  return async function nextApiHandlerWrappedWithIronSession(req, res) {
    ...
    const session = await dist_getIronSession(req, res, sessionOptions);
